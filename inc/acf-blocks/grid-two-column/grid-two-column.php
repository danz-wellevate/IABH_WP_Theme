...
$class_name = 'block--custom-layout__grid-two-column';
if ( ! empty( $block['className'] ) ) {
    $class_name .= ' ' . $block['className'];
}

// ACF fields
$bgColor = get_field('grid-two-column_background_color');
?>
    ...
    <div class="key-pointer">
      <?php if ( have_rows( 'grid_key_takeaways_repeater' ) ) : ?>
        <?php while ( have_rows( 'grid_key_takeaways_repeater' ) ) : the_row();
          ...
          $preheader       = get_sub_field( 'takeaway_preheader' );
        ?>
